package tasks.cleanCode;

import tasks.cleanCode.planes.ExperimentalPlane;
import tasks.cleanCode.planes.MilitaryPlane;
import tasks.cleanCode.planes.PassengerPlane;
import tasks.cleanCode.planes.Plane;
